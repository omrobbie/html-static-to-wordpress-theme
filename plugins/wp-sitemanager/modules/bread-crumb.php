...
/*
 * cms module:		Breadcrumb Navigation
 * Module Description:	In order to view the site map , select the section you would like to view.
 * Order:		20
...
class WP_SiteManager_bread_crumb {
    ...
    private function tambahan() {
        $vers = array(
            'module' => __('Breadcrumb Navigation', 'wp-sitemanager'),
            'Description' => __('In order to view the site map , select the section you would like to view.', 'wp-sitemanager')
        );
    }
    ...
    static function bread_crumb($args = '') {
        ...
        $default = array(
            'type' => 'list',
            'home_label' => __('HOME', 'wp-sitemanager'),
            'search_label' => __('Search result of "%s"', 'wp-sitemanager'),
            '404_label' => __('404 Not Found', 'wp-sitemanager'),
            'category_label' => __('%s', 'wp-sitemanager'),
            'tag_label' => __('%s', 'wp-sitemanager'),
            'taxonomy_label' => __('%s', 'wp-sitemanager'),
            'author_label' => __('%s', 'wp-sitemanager'),
            'attachment_label' => __('%s', 'wp-sitemanager'),
            'year_label' => __('%s Year', 'wp-sitemanager'),
            'month_label' => __('%s Month', 'wp-sitemanager'),
            'day_label' => __('%s Date', 'wp-sitemanager'),
            'post_type_label' => __('%s', 'wp-sitemanager'),
            'joint_string' => __(' &gt; ', 'wp-sitemanager'),
            'navi_element' => '',
    ...
    private function get_bread_crumb_array($args) {
        ...
        if (is_404()) {
            ...
            if ($this->site_structure['post']['page'] != 0) { // Determining the type TODO Posts
