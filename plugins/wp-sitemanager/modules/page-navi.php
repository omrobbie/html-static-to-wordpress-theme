...
/*
 * cms module:		Page Navigation (Pager) 
 * Module Description:	Display Page Navigation (Pager) for archieve page of Category, Date, Author etc. 
 * Order:		30
 * First Introduced:	x
 * Major Changes In:	
 * Builtin:		true
...
class WP_SiteManager_page_navi {
    ...
    static function page_navi($args = '') {
        ...
        $default = array(
            ...
            'edge_type' => 'none',
            'show_adjacent' => true,
            'prev_label' => __('&lt;','wp-sitemanager'),
            'next_label' => __('&gt;','wp-sitemanager'),
            'show_boundary' => true,
            'first_label' => __('&laquo;','wp-sitemanager'),
            'last_label' => __('&raquo;','wp-sitemanager'),
            'show_num' => false,
            'num_position' => 'before',
    ...
    private function tambahan() {
        $vers = array(
            'module' => __('Page Navigation', 'wp-sitemanager'),
            'Description' => __('In the archive page, such as date, author or category, Page Navigation will be display.', 'wp-sitemanager')
        );
    }
